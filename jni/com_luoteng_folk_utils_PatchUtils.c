...
#include "com_luoteng_folk_utils_PatchUtils.h"
...
/*
 * Class:     com_luoteng_folk_utils_PatchUtils
 * Method:    patch
 * Signature: (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
*/
JNIEXPORT jint JNICALL Java_com_luoteng_folk_utils_PatchUtils_patch(JNIEnv *env,
